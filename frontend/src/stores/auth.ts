...
import { ref } from 'vue'
import { fetchMe, login as apiLogin, logout as apiLogout, type CurrentUserInfo, type LoginRequest } from '@/api/auth'
...
export const useAuthStore = defineStore('auth', () => {
  ...
  return { token, user, login, fetchCurrentUser, logout, hasAuthority, isAdmin }
})
